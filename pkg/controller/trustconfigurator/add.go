...
const (
	...
	Type = constants.GardenShootTrustConfiguratorExtensionType
	// Name is the name of the garden shoot trust configurator controller.
	Name = constants.GardenShootTrustConfiguratorExtensionType
	// FinalizerSuffix is the finalizer suffix for the garden shoot trust configurator controller.
	FinalizerSuffix = constants.GardenShootTrustConfiguratorExtensionType
)
